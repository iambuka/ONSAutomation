...
{
    public class Collections : AllBasePOM 
    {
        IWebDriver driver;
        public Collections(IWebDriver driver) : base (driver)
        {
            this.driver = driver;
        }


        public IWebElement CollectionsPage => driver.WaitUntilElementIsDisplayed(By.XPath("//*[@href='/units']"));
