...
{
    public class Terminations : AllBasePOM 
    {
        IWebDriver driver;

        public Terminations(IWebDriver driver) : base(driver)
        {
            this.driver = driver;
        }

        public IWebElement TerminationsPage => driver.WaitUntilElementIsDisplayed(By.XPath("//*[@href='/terminations']"));
