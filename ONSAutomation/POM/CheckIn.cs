...
{
    public class CheckIn : AllBasePOM
    {
        IWebDriver driver;

        public CheckIn(IWebDriver driver) : base (driver)
        {
            this.driver = driver;
        }

        public IWebElement CheckInPage => driver.WaitUntilElementIsDisplayed(By.XPath("//*[@href='/reservations/check-in']"));
