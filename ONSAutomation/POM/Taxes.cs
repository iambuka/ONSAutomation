...
{
    public class Taxes : AllBasePOM
    {
        IWebDriver driver;
        public Taxes(IWebDriver driver) : base(driver)
        {
            this.driver = driver;
        }
        public IWebElement BillingPage => driver.WaitUntilElementIsDisplayed(By.XPath("//*[@href='/taxes']"));
